...
<style type='text/css'>
	select {
		background: rgba(0, 0, 0, 0) url("/thinkphp3.2.3 -/Public/Adminimages/inputbg.png") repeat-x scroll 0 0;
...
<form action="/thinkphp3.2.3 -/index.php/Admin/User/add" method="post">
<div class="main">
