...
<link rel="stylesheet" href="/thinkphp3.2.3 -/Public/Admin/css/home.css" />
...
<div class="article toolbar">
    ...
    <div class="content">
    	<ul class="toollist ue-clear">
    		<li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon01.png" /></a>
                <p><a href="javascript:;">通知公告</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon02.png" /></a>
                <p><a href="javascript:;">知识库</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon03.png" /></a>
                <p><a href="javascript:;">密码修改</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon04.png" /></a>
                <p><a href="javascript:;">日程安排</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon05.png" /></a>
                <p><a href="javascript:;">添加文章</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon06.png" /></a>
                <p><a href="javascript:;">网络硬盘</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon07.png" /></a>
                <p><a href="javascript:;">参数信息</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon08.png" /></a>
                <p><a href="javascript:;">回收站</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/thinkphp3.2.3 -/Public/Admin/images/icon09.png" /></a>
                <p><a href="javascript:;">系统配置</a></p>
            </li>
            <li class="add-btn">
            	<img src="/thinkphp3.2.3 -/Public/Admin/images/add.png" />
            </li>
    	</ul>
