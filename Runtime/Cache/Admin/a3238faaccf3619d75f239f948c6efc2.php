...
<body>
<div class="title"><h2>发件管理</h2></div>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><?php echo ($vo["file"]); if($vo["hasfile"] == 1): ?><a href="/thinkphp3.2.3 -/index.php/Admin/Email/download/id/<?php echo ($vo["id"]); ?>">[下载]</a><?php endif; ?></td>
...
<div class="pagination ue-clear">
	...
	<div class="pxofy">每页显示10条记录 共 <?php echo ($count); ?> 条记录</div>
</div>
</body>
